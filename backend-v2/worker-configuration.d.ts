/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1202da3b6f1bb744acb8e28d58db4e98)
...
declare namespace Cloudflare {
	...
	interface Env {
		userAvatars: R2Bucket;
		BETTER_AUTH_SECRET: string;
		BETTER_AUTH_URL: string;
		TRUSTED_ORIGIN: string;
		PG_URL: string;
		OBJECT_STORAGE_ENDPOINT: string;
		PUBLIC_OBJECT_STORAGE_ENDPOINT: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "TRUSTED_ORIGIN" | "PG_URL" | "OBJECT_STORAGE_ENDPOINT" | "PUBLIC_OBJECT_STORAGE_ENDPOINT">> {}
}
