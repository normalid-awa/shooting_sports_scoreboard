export default {
  __version: '7.0.16',
  'hydrator-verification_4000-full-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
  ...
  'hydrator-verification_4000-full-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Verification ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-verification_4000': function(clone, cloneEmbeddable, processDateProperty) {
  ...
  'hydrator-verification_4000-reference-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Verification ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-verification_4000-reference-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Verification ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-verification_4000': function(isEntityOrRef) {
    // compiled pk getter (with converted custom types) for entity Verification
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-verification_4000': function(isEntityOrRef, getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity Verification
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-user_1000-full-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, shooter_profile_21) {
  ...
  'hydrator-user_1000-full-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, shooter_profile_30) {
    // compiled hydrator for entity User ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'snapshotGenerator-user_1000': function(clone, cloneEmbeddable, processDateProperty) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-user_1000-reference-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity User ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-user_1000-reference-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity User ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-user_1000': function(isEntityOrRef) {
    // compiled pk getter (with converted custom types) for entity User
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-user_1000': function(isEntityOrRef, getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity User
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-shooter_profile_0-full-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_39, user_40, convertToJSValue_sportSpecificData, convertToDatabaseValue_sportSpecificData) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.sportSpecificData === null) {
        entity.sportSpecificData = null;
      } else if (typeof data.sportSpecificData !== 'undefined') {
        if (convertCustomTypes) {
          const value = convertToJSValue_sportSpecificData(data.sportSpecificData);
          data.sportSpecificData = convertToDatabaseValue_sportSpecificData(value);
          entity.sportSpecificData = value;
        } else {
          entity.sportSpecificData = data.sportSpecificData;
        }
      }
      if (data.createdAt === null) {
        entity.createdAt = null;
  ...
  'hydrator-shooter_profile_0-full-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_48, user_49, convertToJSValue_sportSpecificData, convertToDatabaseValue_sportSpecificData) {
    // compiled hydrator for entity ShooterProfile ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_48, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_49, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.sportSpecificData === null) {
        entity.sportSpecificData = null;
  ...
  'comparator-shooter_profile_0': function(compareArrays, compareBooleans, compareBuffers, compareObjects, equals) {
    ...
    return function(last, current, options) {
      ...
      if (current.sport === null && last.sport === undefined) {
        ...
        diff.sport = current.sport;
      } else if (!equals(last.sport, current.sport)) {
        diff.sport = current.sport;
      }
    
      if (current.region === null && last.region === undefined) {
        diff.region = current.region;
      } else if (current.region == null && last.region == null) {
    
      } else if ((current.region != null && last.region == null) || (current.region == null && last.region != null)) {
        diff.region = current.region;
      } else if (!equals(last.region, current.region)) {
        diff.region = current.region;
      }
      ...
      if (current.sportSpecificData === null && last.sportSpecificData === undefined) {
        diff.sportSpecificData = current.sportSpecificData;
      } else if (current.sportSpecificData == null && last.sportSpecificData == null) {
    
      } else if ((current.sportSpecificData != null && last.sportSpecificData == null) || (current.sportSpecificData == null && last.sportSpecificData != null)) {
        diff.sportSpecificData = current.sportSpecificData;
      } else if (!equals(last.sportSpecificData, current.sportSpecificData)) {
        diff.sportSpecificData = current.sportSpecificData;
      }
  ...
  'snapshotGenerator-shooter_profile_0': function(clone, cloneEmbeddable, toArray, EntityIdentifier, convertToDatabaseValue_sportSpecificData, processDateProperty) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
      ...
      if (typeof entity.sport !== 'undefined') {
        ret.sport = clone(entity.sport);
      }
    
      if (typeof entity.region !== 'undefined') {
        ret.region = clone(entity.region);
      }
      ...
      if (typeof entity.sportSpecificData !== 'undefined') {
        ret.sportSpecificData = clone(convertToDatabaseValue_sportSpecificData(entity.sportSpecificData));
      }
  ...
  'resultMapper-shooter_profile_0': function(PolymorphicRef, parseDate) {
    ...
    return function(result) {
      ...
      if (typeof result.region !== 'undefined') {
        ret.region = result.region;
        mapped.region = true;
      }
      if (typeof result.identifier !== 'undefined') {
        ret.identifier = result.identifier;
      ...
      if (typeof result.sport_specific_data !== 'undefined') {
        ret.sportSpecificData = result.sport_specific_data;
        mapped.sport_specific_data = true;
      }
      if (typeof result.created_at !== 'undefined') {
        if (result.created_at == null || result.created_at instanceof Date) {
          ret.createdAt = result.created_at;
  ...
  'hydrator-shooter_profile_0-reference-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity ShooterProfile ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-shooter_profile_0-reference-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity ShooterProfile ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-shooter_profile_0': function(isEntityOrRef) {
    // compiled pk getter (with converted custom types) for entity ShooterProfile
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-shooter_profile_0': function(isEntityOrRef, getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity ShooterProfile
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-session_2000-full-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_61, user_62) {
    ...
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_61, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_62, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
    }
  },
  'hydrator-session_2000-full-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_70, user_71) {
    // compiled hydrator for entity Session ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_70, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_71, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
    }
  },
  ...
  'snapshotGenerator-session_2000': function(clone, cloneEmbeddable, processDateProperty, toArray, EntityIdentifier) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-session_2000-reference-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Session ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-session_2000-reference-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Session ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-session_2000': function(isEntityOrRef) {
    // compiled pk getter (with converted custom types) for entity Session
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-session_2000': function(isEntityOrRef, getCompositeKeyValue, getPrimaryKeyHash) {
    // compiled pk serializer for entity Session
    return function(entity) {
      return '' + entity.id;
    }
  },
  'hydrator-account_3000-full-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_77, user_78) {
  ...
  'hydrator-account_3000-full-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError, user_91, user_92) {
    // compiled hydrator for entity Account ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
      ...
      if (data.user === null) {
        ...
        if (isPrimaryKey(data.user, true)) {
          entity.user = factory.createReference(user_91, data.user, { merge: true, convertCustomTypes, normalizeAccessors, schema });
        } else if (data.user && typeof data.user === 'object') {
          entity.user = factory.create(user_92, data.user, { initialized: true, merge: true, newEntity, convertCustomTypes, normalizeAccessors, schema });
        }
      }
      if (data.accessToken === null) {
        entity.accessToken = null;
  ...
  'snapshotGenerator-account_3000': function(clone, cloneEmbeddable, toArray, EntityIdentifier, processDateProperty) {
    return function(entity) {
      const ret = {};
      if (typeof entity.id !== 'undefined') {
        ret.id = clone(entity.id);
  ...
  'hydrator-account_3000-reference-false': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Account ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'hydrator-account_3000-reference-true': function(isPrimaryKey, isEntity, isScalarReference, Collection, Reference, PolymorphicRef, ValidationError) {
    // compiled hydrator for entity Account ( normalized)
    return function(entity, data, factory, newEntity, convertCustomTypes, schema, parentSchema, normalizeAccessors) {
      if (data.id === null) {
        entity.id = null;
  ...
  'pkGetterConverted-account_3000': function(isEntityOrRef) {
    // compiled pk getter (with converted custom types) for entity Account
    return function(entity) {
      return entity.id;
    }
  },
  'pkSerializer-account_3000': function(isEntityOrRef, getCompositeKeyValue, getPrimaryKeyHash) {
